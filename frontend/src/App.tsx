...
import { createAccount, getExplorerUrl, AccountResponse } from './services/api';
  ...
  return (
    <div>
      <div class="card">
          ...
          <div style={{ "margin-top": "1.5rem" }}>
            ...
            <div style={{ "margin-bottom": "1.5rem" }}>
              <p style={{ "font-size": "0.875rem", "color": "var(--text-secondary)" }}>
                Account will be created on the <strong>{props.network.charAt(0).toUpperCase() + props.network.slice(1)} Network</strong> (selected in the top right)
              </p>
            </div>
            ...
            {error() && (
              <div style={{ "margin-top": "1rem", "padding": "0.75rem", "background-color": "rgba(239, 68, 68, 0.1)", "color": "#ef4444", "border-radius": "6px" }}>
                {error()}
              </div>
            )}
          </div>
        ...
        {createdAccount() && (
          <div style={{ "margin-top": "1.5rem" }}>
            <div style={{ "background-color": "rgba(16, 185, 129, 0.1)", "border-radius": "6px", "padding": "1rem", "margin-bottom": "1.5rem" }}>
              <div style={{ "display": "flex", "align-items": "center", "gap": "0.5rem", "margin-bottom": "0.5rem" }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                  <polyline points="22 4 12 14.01 9 11.01"></polyline>
                </svg>
                <span style={{ "font-weight": "600", "color": "#10b981" }}>Account Created Successfully!</span>
              </div>
            </div>
            ...
            <div style={{ "margin-bottom": "1.5rem" }}>
              ...
              <div style={{ "margin-bottom": "1rem" }}>
                <label style={{ "font-weight": "500", "display": "block", "margin-bottom": "0.25rem" }}>Key Name:</label>
                <div style={{ "font-family": "monospace", "background-color": "var(--bg-light)", "padding": "0.5rem", "border-radius": "4px" }}>
                  {createdAccount()?.name}
                </div>
              </div>

              <div style={{ "margin-bottom": "1rem" }}>
                <label style={{ "font-weight": "500", "display": "block", "margin-bottom": "0.25rem" }}>Address:</label>
                <div style={{ "font-family": "monospace", "background-color": "var(--bg-light)", "padding": "0.5rem", "border-radius": "4px", "word-break": "break-all" }}>
                  <a 
                    href={getExplorerUrl(props.network, createdAccount()?.address || '')}
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ "color": "var(--primary-color)", "text-decoration": "none" }}
                  >
                    {createdAccount()?.address}
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style={{ "margin-left": "0.25rem", "vertical-align": "middle" }}>
              ...
              <div style={{ "margin-bottom": "1rem" }}>
                <label style={{ "font-weight": "500", "display": "block", "margin-bottom": "0.25rem" }}>Mnemonic Phrase:</label>
                ...
                <div style={{ "margin-top": "1rem", "padding": "0.75rem", "background-color": "rgba(245, 158, 11, 0.1)", "border-radius": "6px" }}>
                  <div style={{ "display": "flex", "align-items": "flex-start", "gap": "0.5rem" }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f59e0b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style={{ "margin-top": "0.125rem" }}>
                      <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path>
                      <line x1="12" y1="9" x2="12" y2="13"></line>
                      <line x1="12" y1="17" x2="12.01" y2="17"></line>
                    </svg>
                    <div>
                      <p style={{ "font-weight": "600", "color": "#f59e0b", "margin-bottom": "0.25rem" }}>Important Warning</p>
                      <p style={{ "font-size": "0.875rem", "color": "#92400e" }}>
                        Write this mnemonic phrase in a safe place. It is the <strong>only way</strong> to recover your account if you ever forget your password. Anyone with access to this mnemonic can access your funds.                        
                      </p>
                    </div>
                  </div>
                </div>
...
const ComingSoonPage = ({ title, network }: { title: string, network: string }) => (
...
function App() {
  ...
  const renderPage = () => {
    ...
    switch (activePage()) {
      ...
      case 'supplier':
      case 'gateway':
        return <ComingSoonPage network={network} title={`${activePage().charAt(0).toUpperCase() + activePage().slice(1)} Management`} />;
      default:
        return <AccountPage network={network} />;
    }
  };
